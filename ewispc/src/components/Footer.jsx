    ...
    const links = [
      {
        ...
        items: ["EWIS Official Online Store", "Best Deals", "FAQ"],
      },
      {
        title: "Support",
        items: ["Download Center", "Warranty Status", "Check"],
      },
      {
        title: "About Us",
        items: ["About EWIS", "Branch Network", "Contact Us"],
      },
    ];
  
    return (
      <footer className="bg-[#03613a] text-gray-300 pt-20 pb-10 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-white mb-4">E-WIS</h3>
              <p className="mb-4">
                Bringing you the latest in electronics with exceptional service to enhance your digital lifestyle.
              </p>
